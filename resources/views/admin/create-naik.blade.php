...
<table width="436" height="231" border="0" align="center" style="margin:20px">
  <tr>
	...
	<select name="thnplajaran_id" id="thnplajaran_id" class="form-control">
        ...
        <option value="{{ $ajaran->id}}">{{$ajaran->nm_thnplajaran}}</option>
        @endforeach
...
<p>{{ $loop->iteration }}
<input type="checkbox" name="psertadidik_id" id="psertadidik_id" value="{{ $psertadidik->id }}">
{{ $psertadidik->nama_lengkap }}</p>
